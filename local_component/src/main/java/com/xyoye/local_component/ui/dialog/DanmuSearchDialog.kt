    ...
    override fun initView(binding: DialogSearchDanmuBinding) {
        ...
        setPositiveListener {
            ...
            if (animeName.isEmpty()) {
                ToastCenter.showWarning("The name of the search drama cannot be empty")
            ...
            val episodeId = when {
                binding.episodeRb.isChecked -> {
                    ...
                    if (episodeStr.isEmpty()) {
                        ToastCenter.showWarning("Selected episode type, episode cannot be empty")
                        return@setPositiveListener
                    }
                    episodeStr
                }
