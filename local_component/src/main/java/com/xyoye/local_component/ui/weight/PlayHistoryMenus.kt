...
class PlayHistoryMenus private constructor(
    ...
    private fun showClearConfirmDialog() {
        CommonDialog.Builder(activity).run {
            tips = "Clear play history"
            content = "Clearing the playback record will remove the barrage and subtitle binding records at the same time, are you sure to clear it?"
            addNegative()
            addPositive {
                it.dismiss()
