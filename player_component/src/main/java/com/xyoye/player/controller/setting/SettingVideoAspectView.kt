...
class SettingVideoAspectView(
    ...
    private val videoAspectData = mutableListOf(
        VideoScaleBean(VideoScreenScale.SCREEN_SCALE_DEFAULT, "default"),
        VideoScaleBean(VideoScreenScale.SCREEN_SCALE_16_9, "16:9"),
        VideoScaleBean(VideoScreenScale.SCREEN_SCALE_4_3, "4:3"),
        VideoScaleBean(VideoScreenScale.SCREEN_SCALE_ORIGINAL, "original"),
        VideoScaleBean(VideoScreenScale.SCREEN_SCALE_MATCH_PARENT, "filling"),
        VideoScaleBean(VideoScreenScale.SCREEN_SCALE_CENTER_CROP, "cut out")
    )
