...
class SettingDanmuConfigureView(
    ...
    private fun applyScrollDanmuConfigure() {
        viewBinding.tvLineLimitTips.text = "Scroll barrage line limit"
        viewBinding.tvDanmuEnableTips.text = "Enable scrolling bullet chat"
    ...
    private fun applyTopDanmuConfigure() {
        viewBinding.tvLineLimitTips.text = "Top barrage line limit"
        viewBinding.tvDanmuEnableTips.text = "Enable Top Danmu"
    ...
    private fun applyBottomDanmuConfigure() {
        viewBinding.tvLineLimitTips.text = "Line limit for bottom barrage"
        viewBinding.tvDanmuEnableTips.text = "Enable bottom barrage"
        viewBinding.groupScreenLimit.isVisible = false
