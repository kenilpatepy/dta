...
class PlayerSettingFragment : PreferenceFragmentCompat() {
    companion object {
        ...
        val vlcHWDecode = mapOf(
            Pair("Auto", VLCHWDecode.HW_ACCELERATION_AUTO.value.toString()),
            Pair("Disable", VLCHWDecode.HW_ACCELERATION_DISABLE.value.toString()),
            Pair("Decoding Acceleration", VLCHWDecode.HW_ACCELERATION_DECODING.value.toString()),
            Pair("Full Acceleration", VLCHWDecode.HW_ACCELERATION_FULL.value.toString())
        )

        val vlcAudioOutput = mapOf(
            Pair("automatic", VLCAudioOutput.AUTO.value),
