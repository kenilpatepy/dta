...
class StorageFileAdapter(
    ...
    private enum class ManageAction(val title: String, val icon: Int) {
        SCREENCAST("cast screen", com.xyoye.common_component.R.drawable.ic_video_cast),
        BIND_DANMU("Manually find danmu", com.xyoye.common_component.R.drawable.ic_bind_danmu_manual),
        BIND_SUBTITLE("Manually find subtitles", com.xyoye.common_component.R.drawable.ic_bind_subtitle),
        UNBIND_DANMU("Unbind Danmu", com.xyoye.common_component.R.drawable.ic_unbind_danmu),
        UNBIND_SUBTITLE("Unbind subtitle", com.xyoye.common_component.R.drawable.ic_unbind_subtitle);
